          ...
          <table className="min-w-full divide-y divide-gray-200 ">
            <thead className="bg-gray-50 ">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700 ">Tenure</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700 ">EMI</th>
            ...
            <tbody className="divide-y divide-gray-100 ">
              {loans.map((loan) => (
                <tr key={loan.id} className="transition-colors hover:bg-gray-50 :bg-gray-800/60">
